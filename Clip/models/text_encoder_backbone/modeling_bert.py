...
from models.image_encoder_backbone.utils import LayerNorm
...
class BertSdpaSelfAttention(BertSelfAttention):
    def __init__(self, config, position_embedding_type=None):
        ...
        self.require_contiguous_qkv = version.parse(
            get_torch_version()) < version.parse("2.2.0")
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        changed_type: Optional[torch.dtype] = None,
        ...
        use_sdpa_attention_masks = (
            self.attn_implementation == "sdpa" and self.position_embedding_type == "absolute" and head_mask is None and not output_attentions)
