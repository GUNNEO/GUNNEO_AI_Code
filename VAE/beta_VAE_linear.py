...
class BetaVAE(BaseVAE):
    ...
    def __init__(self,
        ...
        for h_dim in hidden_dims:
            self.encoder_linear_layers.append(
        ...
        self.fc_mu = nn.Linear(
            hidden_dims[-1] * context_length, latent_dim)
    ...
    def encode(self, input: Tensor) -> List[Tensor]:
        ...
        """
        for linear, bn, relu in zip(self.encoder_linear_layers, self.encoder_bn_layers, self.encoder_relu_layers):
            input = linear(input)
    ...
    def decode(self, z: Tensor) -> Tensor:
        ...
        for linear, bn, relu in zip(self.decoder_linear_layers, self.decoder_bn_layers, self.decoder_relu_layers):
