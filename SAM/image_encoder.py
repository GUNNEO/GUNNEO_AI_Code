...
def get_rel_pos(q_size: int, k_size: int, rel_pos: torch.Tensor) -> torch.Tensor:
    ...
    # given the index of q and k, calculate every q points to very k points distance
...
if __name__ == "__main__":
    model = ImageEncoderViT(depth=1, use_rel_pos=True)
