...
def merge_pre_bn(module, pre_bn_1, pre_bn_2=None):
    ...
    if module.bias is None:
        zeros = torch.zeros(module.out_channels,
                            device=weight.device).type(weight.type())
    ...
    if pre_bn_2 is None:
        ...
        extra_bias = pre_bn_1.bias - pre_bn_1.weight * \
            pre_bn_1.running_mean * scale_invstd
    else:
        assert pre_bn_1.track_running_stats is True, "Unsupport bn_module.track_running_stats is False"
        assert pre_bn_1.affine is True, "Unsupport bn_module.affine is False"
        ...
        extra_bias = scale_invstd_2 * pre_bn_2.weight * \
            (pre_bn_1.bias - pre_bn_1.weight * pre_bn_1.running_mean *
             scale_invstd_1 - pre_bn_2.running_mean) + pre_bn_2.bias
